    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div ref={seekBg} onClick={seekSong} className='w-[60vw] max-w-[500px] bg-gray-600 rounded-full cursor-pointer h-1'>
                    <hr ref={seekBar} className='h-1 border-none w-0 bg-#E6E6FA-500 rounded-full'/>
                </div> 
        ...
        <div className='hidden lg:flex items-center gap-2 opacity-75'>
            ...
            <img 
                ...
                className={`w-4 cursor-pointer hover:scale-110 transition-transform ${showQueue ? 'text-#E6E6FA-500' : 'opacity-70 hover:opacity-100'}`} 
