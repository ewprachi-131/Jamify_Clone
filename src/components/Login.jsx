    ...
    <div className='min-h-screen bg-[#E6E6FA] flex items-center justify-center p-4'>
      ...
      <div className='bg-black rounded-lg p-8 w-full max-w-md'>
        <div className='text-center mb-8'>
          <img className='w-12 h-12 mx-auto mb-4' src={assets.jamify_logo} alt="Jamify" />
          <h1 className='text-white text-3xl font-bold mb-2'>
            {isSignUp ? 'Sign up for Jamify' : 'Log in to Jamify'}
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button
            type='submit'
            className='w-full bg-[#E6E6FA] hover:bg-[#1ed760] text-black font-bold py-3 px-4 rounded-full transition-colors'
          >
        ...
        <div className='mt-6 text-center'>
          <p className='text-gray-400'>
            ...
            <button
              ...
              className='text-white hover:text-[#E6E6FA] ml-2 underline'
            >
              {isSignUp ? 'Log in here' : 'Sign up for Jamify'}
            </button>
          </p>
        </div>
