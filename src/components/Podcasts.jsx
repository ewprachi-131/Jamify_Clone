          ...
          {podcastsData.map((podcast) => (
            ...
            >
              <div className='relative mb-4'>
                ...
                <div className='absolute bottom-2 right-2 bg-#E6E6FA-500 rounded-full p-3 opacity-0 group-hover:opacity-100 transition-opacity shadow-lg'>
          ...
          {podcastsData.slice(0, 3).map((podcast, index) => (
            ...
            >
              ...
              <div className='opacity-0 group-hover:opacity-100 transition-opacity'>
                <div className='bg-#E6E6FA-500 rounded-full p-2'>
                  <svg className='w-4 h-4 text-black' fill='currentColor' viewBox='0 0 24 24'>
                    <path d='M8 5v14l11-7z'/>
                  </svg>
                </div>
