    ...
    <>
      ...
      <div className='mb-6'>
        ...
        <div className='flex items-center gap-3 p-2 bg-[#1a1a1a] rounded-md'>
          ...
          <div className='w-4 h-4 bg-#E6E6FA-500 rounded-full flex items-center justify-center'>
        ...
        <div className='space-y-2'>
          {upNext.map((song, index) => (
            ...
            >
              ...
              <div className='flex-1 min-w-0'>
                <p className='text-white text-sm font-medium truncate group-hover:text-#E6E6FA-400'>{song.name}</p>
